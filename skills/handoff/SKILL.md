...
2. **Decide dónde va.** En orden:
   ...
   - Nunca cruces ámbitos: lo de la empresa en `Documents\`, lo personal y del
     ITAM en `~\Personal\`. El traspaso no se sube a ningún lado.
...
2. **Ponle nombre a ESTE chat, no al que sigue.** Analiza el tema real del
   ...
   "Tienda en línea — redes sociales", no "sesión de traspaso"). Con varios chats
